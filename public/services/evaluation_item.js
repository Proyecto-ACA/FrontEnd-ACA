...
// Funcion para obtener evaluación
...
function rederSign(flag) {
    ...
    //agregar botones verdadero falso y llamar myRespuesta con res= 1 verdadero, 0 falso
...
//Funcion para gestionar las respuestas
                    ...
                    <div class="row ">
                        ...
                        <div class="col-6 row">
                            ...
                            <div class="col-6 row">
                                ...
                                <h3 class="text-light mt-2">${Math.round((puntaje * 10 / (data.length))* 100) / 100}</h3>
                            </div>
                        </div>
                    </div>
                </div>
